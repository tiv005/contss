...
<body>
	...
	<form action="financ/FinancAaudit" id="f1" method="post"
	...
	<h5 class="page-header alert-info" style="margin: 0px; padding: 10px; margin-bottom: 10px;">经理审核</h5>
			...
			<div class="col-xs-7 ">
				 <div class="form-group">
				    ...
				    <div class="col-xs-9">
				     	<div class="radio">
				     	<label>
				    	<input type="radio" checked="checked" name="a_State" value="3"/>财务审核通过
				    	</label>
				    	</div>
				    	 <div class="radio">
				    	 <label>
				  	 	<input type="radio" name="a_State" value="-2"/>财务审核不通过
				  	 	</label>
				  	 	</div>
				  	 </div>	
		...
		<div class="row">
			<div class="col-sm-7" align="center">
				...
				<a href="finance/financAauditServlet" class="btn btn-warning">返回上一级</a>
			</div>
		</div>
	</form>
