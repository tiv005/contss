...
<form action="system/addCost" id="f1" method="post" class="form-horizontal">
		...
		<div class="row">
			<div class="col-xs-9">
				<div class="form-group ">
					...
					<div class="col-xs-9 ">
						<input type="text" class="form-control" required name="cName" value="${cots.cName }" placeholder="请输入费用名称" />
					</div>
				</div>
			</div>
			<div class="col-xs-9">
				<div class="form-group ">
					...
					<div class="col-xs-9 ">
						<textarea rows="" cols="" class="form-control" name="cDesc">${cots.cDesc }</textarea>
					</div>
				</div>
			</div>
		</div>
