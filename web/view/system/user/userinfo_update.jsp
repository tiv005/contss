		...
		<div class="row">
			<div class="col-xs-5">
				<div class="form-group ">
					...
					<div class="col-xs-9 ">
						<input type="text" class="form-control" required name="uName" value="${users.uName }" placeholder="请输入用户姓名" />
					</div>
				</div>
			</div>
			<div class="col-xs-5">
				<div class="form-group ">
					...
					<div class="col-xs-9 ">
						<input type="text" class="form-control" name="uAge" value="${users.uAge }" placeholder="请输入用户年龄" />
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row">
				...
				<div class="form-group ">
					...
					<div class="col-xs-3 ">
						<select name="uSex" class="form-control">
							<option ${users.uSex=='保密'?'selected':'' } value="保密">保密</option>
							<option ${users.uSex=='男'?'selected':'' } value="男">男</option>
							<option ${users.uSex=='女'?'selected':'' } value="女">女</option>
						</select>
					</div>
				</div>
			</div>
			<div class="col-xs-5">
				<div class="form-group ">
					...
					<div class="col-xs-9 ">
						<input type="text" class="form-control" name="uPhone" value="${users.uPhone }" placeholder="请输入电话号码" />
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-xs-5">
				<div class="form-group ">
					...
					<div class="col-xs-4 ">
						<select name="r_Id" class="form-control" readonly="readonly">
							<option ${users.r_Id=='1'?'selected':'' } value="1">普通员工</option>
							<option ${users.r_Id=='2'?'selected':'' } value="2">部门经理</option>
							<option ${users.r_Id=='3'?'selected':'' } value="3">财务人员</option>
							<option ${users.r_Id=='4'?'selected':'' } value="4">超级管理员</option>
						</select>
					</div>
				</div>
			</div>
			<div class="col-xs-5">
				<div class="form-group ">
					...
					<div class="col-xs-9 ">
						<input type="text" class="form-control" name="uSalary" readonly="readonly" value="${users.uSalary }" placeholder="请输入薪资" />
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-xs-5">
				<div class="form-group ">
					...
					<div class="col-xs-9">
						<input type="text" class="form-control" required name="uAccout"  readonly="readonly" value="${users.uAccout }"  id="userAccount" placeholder="请输入用户账号" />
			...
			<div class="col-xs-5">
				<div class="form-group ">
					...
					<div class="col-xs-9 ">
						<input type="text" class="form-control"  value="${users.uPwd }"  required name="uPwd" placeholder="请输入用户密码" />
					</div>
				</div>
			</div>
		</div>
