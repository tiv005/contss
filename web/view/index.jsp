				...
				<ul class="nav ace-nav">
					...
					<li class="light-blue"><a data-toggle="dropdown" href="#"
						class="dropdown-toggle"> <img class="nav-user-photo"
							...
							class="user-info"> <small>欢迎光临,${users.uAccout }</small>
						</span> <i class="icon-caret-down"></i>
					</a>
						<ul
							class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
							
							<li><a href="system/pageUsesInfoServlet"  target="mainframe"> <i class="icon-user"></i> 个人资料
							</a></li>

							<li class="divider"></li>

							<li><a href="system/outLoginServlet"> <i class="icon-off"></i> 退出
							</a></li>
						</ul></li>
				</ul>
				<!-- /.ace-nav -->
		...
		<div class="main-container-inner">
			...
			<div class="sidebar" id="sidebar">
				...
				<ul class="nav nav-list">
					<li class="active"><a
						href="view/main.jsp" target="mainframe">
							<i class="icon-dashboard"></i> <span class="menu-text">
								控制台 </span>
					</a></li>
					<c:forEach var="menu" items="${listMneu }">
						<c:if test="${menu.p_MenuId==0 }">
						    <li><a href="javascript:void(0)" target="mainframe"
									class="dropdown-toggle"> <i class="icon-desktop"></i> <span
										class="menu-text"> ${menu.m_Name } </span> <b class="arrow icon-angle-down"></b>
								</a>
			
									<ul class="submenu">
										<c:forEach var="child" items="${listMneu }">
											<c:if test="${child.p_MenuId==menu.m_Id }">
					                            <li><a href="${child.m_Url }" target="mainframe"> <i
														class="icon-double-angle-right"></i> ${child.m_Name}
												</a></li>
											</c:if>
			                      	   </c:forEach>
									</ul>
			...
			<div class="main-content" id="mains">
				<iframe id="mainframe" name="mainframe" src="view/main.jsp"
