...
<div>
	...
	<form action="expense/selectExpenseServlet" id="f1" method="post" class="form-inline">
		<div class="row alert alert-info" style="margin: 0px; padding: 5px;">
			<div class="form-group">
			<label>报销人:</label> <input type="text" class="form-control"     name="uName" value="${expense.uName }" placeholder="请输入报销人姓名" />
			...
			<select class="form-control" name="eState">
				...
				<option value="1" ${expense.eState=='1'?'selected':'' } >已提交未审核</option>
		...
		<div class="row" style="padding: 15px;">
			<d:table class="table table-hover table-condensed" name="expemsesList" pagesize="4" requestURI="expense/selectExpenseServlet">
				<d:column property="eId" title="报销编号"></d:column>
				<d:column property="uName" title="报销人"></d:column>
				<d:column property="eName" title="报销名称"></d:column>
				...
				<d:column value="查看详情" title="查看详情" href="expense/showExpenseDetail"  paramId="expenseId" paramProperty="eId"></d:column>
